...
class MetricsEvaluationTest {
    ...
    void testMetricComparisonManager() {
        ...
        try {
            ...
            MetricEvaluationPerPost comparison_a_3758880 = manager.getMetricEvaluation(3758880, "fourGramOverlap", 0.6);

            /* compare a 3758880 */
            // first version has never predecessors
            int postHistoryId = postHistoryIds_3758880.get(0);

            MetricResult resultsText = comparison_a_3758880.getResultsText(postHistoryId);
            ...
            MetricResult resultsCode = comparison_a_3758880.getResultsCode(postHistoryId);
            ...
            MetricEvaluationPerPost comparison_a_22037280 = manager.getMetricEvaluation(22037280, "fourGramOverlap", 0.6);
